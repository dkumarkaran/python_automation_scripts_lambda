def handler(event, context):    
    ...
    # define the regions
    regions = ['us-east-1', 'ap-south-1', 'ap-south-2']
    html_individual_regions = ""
    for re in regions:
        print(f"========================={re}=======================================\n")
        client = boto3.client('ec2', region_name=re)
        ...
        for r in response['Reservations']:
            for i in r['Instances']:
                ...
                # data["AZ"].append(az)
                client01 = boto3.client('ec2', region_name=re)
                ...
                client02 = boto3.client('ec2', region_name=re)
                ...
                instances_client = boto3.client('ec2', region_name=re)
        ...
        body = df.to_html()
        body_html = '<html>\n' + body + '\n</html>'
        html_individual_regions = html_individual_regions + body_html
        print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
        print(body_html)
        html_individual_regions=html_individual_regions+"\n"+re+"\n"
        print(html_individual_regions)
        print(":::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::")
    ...
    sender_email = 'nagababu.medicharla@searce.com'
    recipient_email = 'nagababu.medicharla@searce.com'
    subject = 'instance details in nv,mumbai,hyd regions.'
    message = {
        'Subject': {'Data': subject},
        'Body': {'Html': {'Data': html_individual_regions}}
    }
